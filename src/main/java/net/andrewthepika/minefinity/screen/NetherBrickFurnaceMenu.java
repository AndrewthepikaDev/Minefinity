...
import net.andrewthepika.minefinity.block.entity.NetherBrickFurnaceBlockEntity;
...
public class NetherBrickFurnaceMenu extends AbstractContainerMenu {
    ...
    public NetherBrickFurnaceMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.NETHER_BRICK_FURNACE_MENU.get(), id);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 43, 17));
            this.addSlot(new SlotItemHandler(handler, 1, 115, 17));
            this.addSlot(new SlotItemHandler(handler, 2, 79, 62));
        });
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (index < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT){
            ...
            System.out.println("L + ratio + invalid slotindex: " +  index);
            return ItemStack.EMPTY;
        }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.NETHER_BRICK_FURNACE.get());
    }
